        ...
        <div className="p-8 space-y-8 max-w-7xl mx-auto h-full overflow-y-auto scrollbar-hide">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 font-bold mt-1">Kelola 7 Aspek domain makro Pemerintah Digital</p>
                </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-100 p-20 text-center shadow-sm">
                ...
                <p className="text-slate-500 font-bold mt-2">Daftar domain SPBE akan dimuat dari tabel Supabase: `aspeks`.</p>
            </div>
        </div>
    );
};
